        ...
        <div class="popup hide" id="popup2">
            <div>
                ...
                <div class="hide" id="AddStep2">
                    ...
                    <p>Si vous possèdez un <b>compte GitHub</b>, vous pouvez ajouter directement votre projet.</p><a href="https://github.com/Konsilion/Katalog/edit/master/mkdocs/docs/catalogues/laboratoires/data/data.csv" target="_blank">
