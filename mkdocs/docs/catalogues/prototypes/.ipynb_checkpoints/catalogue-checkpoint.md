...
<head>
    ...
    <h2 style="text-align:center; margin-top:0px;">Comment ajouter un projet ?</h2><hr>
        ...
        <p>Vous pouvez également remplir notre <b>formulaire contact</b></p><a href="https://www.google.com" target="_blank"><button class="neumorphic-btn" style="width:100%;"><i class="fa-solid fa-plus"></i> Ajouter votre projet</button></a><hr>
    </div>
        </div>
    </div>   
    </body>
